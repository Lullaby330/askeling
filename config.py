...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7326709355:AAF_dqaomyD_LyjbKVlb_1ok9ua5UtEkwtQ")
...
DB_NAME = os.environ.get("DATABASE_NAME", "askeling")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002243011293"))
