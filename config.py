...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6521266182:AAFbH0pUxFerIbACY-YPIw3p4k8s5dX4T1M")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS",  "6282946877 1967364224").split()):
        ADMINS.append(int(x))
except ValueError:
